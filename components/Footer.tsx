...
export const Footer = () => <footer className="mt-16 bg-[#4a2a22] text-white">
  <div className="container-custom grid gap-10 py-12 md:grid-cols-[1.35fr_.75fr_.75fr_1fr]">
    <div><Link href="/" className="text-2xl font-black tracking-[-.06em]">HANGROW<span className="text-[#eba11d]">.</span></Link><p className="mt-4 max-w-xs text-sm leading-relaxed text-white/65">Curated snacks for every everyday moment. Delivered simply, quickly and with care.</p></div>
  ...
  <div className="border-t border-white/15"><div className="container-custom py-5 text-xs text-white/45">© 2026 Hangrow. All rights reserved.</div></div>
</footer>
